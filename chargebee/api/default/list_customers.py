...
def list_customers(
    ...
    r"""List customers
     ...
     Retrieves a list of customers added to your Chargebee site. The list contains the necessary customer
    details such as First Name, Last Name and the Customer ID.
    ...
    Returns:
        Iterator of 'ListCustomersResponse200ListItem' items
    """
